...
{
    CGRect tempFrame = CGRectMake(self.bounds.origin.x, self.bounds.origin.y, 25, 25);
    CGRect knobFrame = CGRectInset(tempFrame, 2.0, 2.0);
    UIBezierPath *knobPath = [UIBezierPath bezierPathWithRoundedRect:knobFrame
                                                        cornerRadius:knobFrame.size.height * self.slider.curvatiousness];
...
//    CGContextSetStrokeColorWithColor(ctx, [UIColor grayColor].CGColor);
    ...
    UIBezierPath *clipPath = [UIBezierPath bezierPathWithRoundedRect:rect
                                                        cornerRadius:rect.size.height * self.slider.curvatiousness];
