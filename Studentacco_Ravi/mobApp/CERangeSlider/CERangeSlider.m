...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _trackColour = [UIColor colorWithPatternImage:[UIImage imageNamed:@"filter-slider"]];
        _knobColour = [UIColor colorWithPatternImage:[UIImage imageNamed:@"slider-circle"]];
        _curvatiousness = 1.0;
        // Initialization code
        _maximumValue = 25000.0;
        _minimumValue = 2000.0;
        _upperValue = 25000.0;
        _lowerValue = 2000.0;
